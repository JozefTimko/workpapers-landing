// Variant 8 — near-black graphite with cyan accents
...
export const metadata: Metadata = {
  title: "WorkPapers.ai — Variant 8",
  description: "Near-black graphite base with cyan highlights.",
};
    ...
    <main className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-800">
      ...
      <Section className="pt-8">
        <div className="max-w-3xl text-center mx-auto">
          <h1 className="text-8xl font-semibold tracking-tight bg-gradient-to-b from-cyan-200 to-white bg-clip-text text-transparent">AI Workpapers</h1>
      ...
      <Section id="waitlist" className="py-0">
        <div className="rounded-3xl bg-cyan-600 p-6 sm:p-8">
          <div className="grid items-center gap-6 sm:grid-cols-2">
            <div>
              <h3 className="text-xl font-semibold text-white">Be first to try WorkPapers</h3>
              <p className="mt-1 text-cyan-100">Join the waitlist and we’ll notify you when early access opens.</p>
            </div>

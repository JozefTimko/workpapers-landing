// Variant 6 — deep navy with gold accents
...
export const metadata: Metadata = {
  title: "WorkPapers.ai — Variant 6",
  description: "Professional navy base with amber (gold) accents.",
};
    ...
    <main className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-800">
      ...
      <Section className="pt-8">
        <div className="max-w-3xl text-center mx-auto">
          <h1 className="text-8xl font-semibold tracking-tight bg-gradient-to-b from-amber-200 to-white bg-clip-text text-transparent">AI Workpapers</h1>
      ...
      <Section id="waitlist" className="py-0">
        <div className="rounded-3xl bg-amber-600 p-6 sm:p-8">
          <div className="grid items-center gap-6 sm:grid-cols-2">
            <div>
              <h3 className="text-xl font-semibold text-slate-950">Be first to try WorkPapers</h3>
              <p className="mt-1 text-amber-900/90">Join the waitlist and we’ll notify you when early access opens.</p>
            </div>

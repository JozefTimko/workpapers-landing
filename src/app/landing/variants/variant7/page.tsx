// Variant 7 — dark plum with violet accents
...
export const metadata: Metadata = {
  title: "WorkPapers.ai — Variant 7",
  description: "Dark plum base with violet accents.",
};
...
function Feature({ title, body }: { title: string; body: string }) {
  return (
    <div className="rounded-2xl border border-violet-700/60 bg-slate-900/70 p-5 shadow-sm">
    ...
    <main className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-800">
      ...
      <Section className="pt-8">
        <div className="max-w-3xl text-center mx-auto">
          <h1 className="text-8xl font-semibold tracking-tight bg-gradient-to-b from-violet-200 to-white bg-clip-text text-transparent">AI Workpapers</h1>
      ...
      <Section className="pt-0">
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-2">
          <div className="rounded-2xl border border-violet-700/60 bg-slate-900/70 p-3 shadow-sm">
            <div className="aspect-video overflow-hidden rounded-xl border border-violet-700/60">
      ...
      <Section id="waitlist" className="py-0">
        <div className="rounded-3xl bg-violet-600 p-6 sm:p-8">
          <div className="grid items-center gap-6 sm:grid-cols-2">
            <div>
              <h3 className="text-xl font-semibold text-white">Be first to try WorkPapers</h3>
              <p className="mt-1 text-violet-100">Join the waitlist and we’ll notify you when early access opens.</p>
            </div>

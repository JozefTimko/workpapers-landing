// Variant 3 — charcoal with orange accents
...
export const metadata: Metadata = {
  title: "WorkPapers.ai — Variant 3",
  description: "Charcoal base with warm orange accents.",
};
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-800">
      ...
      <Section id="waitlist" className="py-0">
        <div className="rounded-3xl bg-orange-600 p-6 sm:p-8">
          <div className="grid items-center gap-6 sm:grid-cols-2">
            <div>
              <h3 className="text-xl font-semibold text-white">Be first to try WorkPapers</h3>
              <p className="mt-1 text-orange-100">Join the waitlist and we’ll notify you when early access opens.</p>
            </div>

// Variant 10 — neon on dark (cyan/pink accents)
...
export const metadata: Metadata = {
  title: "WorkPapers.ai — Variant 10",
  description: "High-contrast dark with neon cyan and fuchsia accents.",
};
...
function Feature({ title, body }: { title: string; body: string }) {
  return (
    <div className="rounded-2xl border border-slate-700 bg-slate-900 p-5 shadow-sm">
      ...
      <p className="mt-1 text-sm text-fuchsia-200/90">{body}</p>
    </div>
  );
}
    ...
    <main className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-800">
      ...
      <Section className="pt-8">
        <div className="max-w-3xl text-center mx-auto">
          <h1 className="text-8xl font-semibold tracking-tight bg-gradient-to-r from-cyan-300 via-white to-fuchsia-300 bg-clip-text text-transparent">AI Workpapers</h1>
      ...
      <Section className="pt-0">
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-2">
          <div className="rounded-2xl border border-slate-700 bg-slate-900 p-3 shadow-sm">
            ...
            <p className="mt-2 text-center text-xs text-cyan-300/90">Connect Xero and generate year-end workpapers with suggested narratives.</p>
          </div>
          ...
          <div className="rounded-2xl border border-slate-700 bg-slate-900 p-3 shadow-sm">
            ...
            <p className="mt-2 text-center text-xs text-fuchsia-300/90">Bank statement (PDF) converted into an Excel cashbook with allocations and review flags.</p>
          </div>
        </div>
      </Section>
      ...
      <Section id="waitlist" className="py-0">
        <div className="rounded-3xl bg-gradient-to-r from-cyan-500 to-fuchsia-500 p-6 sm:p-8">
          <div className="grid items-center gap-6 sm:grid-cols-2">
            <div>
              <h3 className="text-xl font-semibold text-white">Be first to try WorkPapers</h3>
              <p className="mt-1 text-white/90">Join the waitlist and we’ll notify you when early access opens.</p>
            </div>

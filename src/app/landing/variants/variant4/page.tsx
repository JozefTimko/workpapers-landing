// Variant 4 — deep teal on charcoal
...
export const metadata: Metadata = {
  title: "WorkPapers.ai — Variant 4",
  description: "Deep charcoal base with teal accents.",
};
...
function Feature({ title, body }: { title: string; body: string }) {
  return (
    <div className="rounded-2xl border border-teal-700/60 bg-slate-900/70 p-5 shadow-sm">
      <h3 className="text-base font-semibold text-teal-200">{title}</h3>
    ...
    <main className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-800">
      ...
      <Section className="pt-8">
        <div className="max-w-3xl text-center mx-auto">
          <h1 className="text-8xl font-semibold tracking-tight bg-gradient-to-b from-teal-200 to-white bg-clip-text text-transparent">AI Workpapers</h1>
      ...
      <Section className="pt-0">
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-2">
          <div className="rounded-2xl border border-teal-700/60 bg-slate-900/70 p-3 shadow-sm">
            <div className="aspect-video overflow-hidden rounded-xl border border-teal-700/60">
              <Video videoId="tXd4h9Su0mE" title="Xero → Workpapers" />
            </div>
            <p className="mt-2 text-center text-xs text-slate-300/90">Connect Xero and generate year-end workpapers with suggested narratives.</p>
          </div>
          ...
          <div className="rounded-2xl border border-teal-700/60 bg-slate-900/70 p-3 shadow-sm">
            ...
            <p className="mt-2 text-center text-xs text-slate-300/90">Bank statement (PDF) converted into an Excel cashbook with allocations and review flags.</p>
          </div>
        </div>
      </Section>
      ...
      <Section id="waitlist" className="py-0">
        <div className="rounded-3xl bg-teal-600 p-6 sm:p-8">
          <div className="grid items-center gap-6 sm:grid-cols-2">
            <div>
              <h3 className="text-xl font-semibold text-white">Be first to try WorkPapers</h3>
              <p className="mt-1 text-teal-100">Join the waitlist and we’ll notify you when early access opens.</p>
            </div>
